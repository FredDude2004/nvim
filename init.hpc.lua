...
vim.keymap.set("n", "-", ":Ex<CR>", { desc = "Open up file Explorer" })
...
------------------------------------------------------------
-- PLUGINS (builtin vim.pack, no manager needed)
------------------------------------------------------------
------------------------------------------------------------
-- PLUGINS (lazy.nvim)
------------------------------------------------------------
...
------------------------------------------------------------
-- COMPLETION (BUILT-IN, LIGHTWEIGHT)
------------------------------------------------------------
...
-- Prefer pyright if available, fallback to pylsp
if vim.fn.executable("pyright-langserver") == 1 then
  lspconfig.pyright.setup({})
elseif vim.fn.executable("pylsp") == 1 then
  lspconfig.pylsp.setup({})
else
  vim.notify("No Python LSP found (pyright-langserver or pylsp)", vim.log.levels.WARN)
end
